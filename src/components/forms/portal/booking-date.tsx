  ...
  return (
    <div className="flex flex-col gap-5 justify-center">
      <div className="flex justify-center">
        <h2 className="text-4xl font-bold mb-5">Reservar una reunión</h2>
      </div>
      <div className="flex gap-10 flex-col sm:flex-row">
        <div className="w-[300px]">
          <h6>Llamada de descubrimiento</h6>
          <CardDescription>
            Durante esta llamada, nuestro objetivo es explorar posibles vías de colaboración, oportunidades de promoción o cualquier otro medio mediante el cual podamos contribuir al éxito de su empresa.
          </CardDescription>
        </div>
        <div>
          <Calendar
